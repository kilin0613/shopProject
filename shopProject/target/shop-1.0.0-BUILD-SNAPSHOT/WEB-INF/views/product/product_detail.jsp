			...
			<div
				...
				<ul>
					...
					<li><p>
							...
							<input type="submit" formaction="${pageContext.request.contextPath}/basket" value="장바구니" formmethod="get"  onclick="return checkValue()">
								...
								<c:if test="${loginMember eq null}"><!--로그인x(세션해제상태) 추가로 표시(get으로 로그인창)-->
									<input type="submit" formaction="${pageContext.request.contextPath}/favorites" value="즐겨찾기 추가" formmethod="get">
								</c:if>
								
							<input type="submit" formaction="${pageContext.request.contextPath}/orderAndPayment" value="바로구매" formmethod="get" onclick="return checkValue()">
						</p></li>
				</ul>
				</form>
			</div>
