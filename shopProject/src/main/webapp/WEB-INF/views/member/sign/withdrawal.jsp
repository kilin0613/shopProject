								...
								<tr>
									<td>
										<ol>
											...
											<li>이메일 내용, 블로그, 카페, 개인홈페이지 등 기타 아이디와 연계된 모든 사적인 영역의 정보와
												게시물 삭제 <br>회원탈퇴 후, 해당 서비스를 더이상 이용할 수 없으며, 모든 사적인 정보는
												삭제됩니다.
											</li>
										...
										<td align="center">
											<table border="0" width="80%">
												...
												<tr>
													...
													<td><input type="password" id="upw" name="pw"
						...
						<table id="mi_table">
							<form>
								<tr>
									<td>&nbsp;</td>
									<td colspan="2" align="center" valign="middle"><input
										type="submit" name="submit" value="탈퇴하기"
										style="width: 150; height: 40; font-size: 14px; font-weight: bold;" /></td>
									<td>&nbsp;</td>
