					...
					<tr>
						<td>
							<table border="0">
								...
								<tr>
									<td width="80"><font size="4"><strong>구매완료</strong></font></td>
									<td>&nbsp;</td>
								</tr>
								<tr>
							...
							<table height="240px"></table>
							<table style="margin-left: auto; margin-right: auto;"border="1" width="600px">
								<tr>
					...
					<table id="mi_table">
								<tr>
									...
									<td colspan="2" align="center" valign="middle"><input
										type="submit" name="submit2" value="장바구니"
										style="width: 150; height: 40; font-size: 14px; font-weight: bold;" /></td>
										<td>&nbsp;</td>
									<td colspan="2" align="center" valign="middle"><input
										type="submit" name="submit2" value="확인"
										style="width: 150; height: 40; font-size: 14px; font-weight: bold;" /></td>
								</tr>
